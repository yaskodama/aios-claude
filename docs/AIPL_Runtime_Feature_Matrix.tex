...
\begin{longtable}{p{3.0cm} p{5.5cm} p{2.8cm} p{6.4cm} p{4.0cm}}
  ...
  AI cooperative pattern & \texttt{CooperativeNowFuture\{,-jp,-jp-remote\}}, \texttt{CooperativeSolve\{,-jp,Remote,Remote-jp\}}, \texttt{SessionTyped}, \texttt{Reviewer}, \texttt{Fanout}, \texttt{PriorityFanout} & py-aipl/samples-ai + abclc/ai-samples & Planner$\to$Solver$\to$Reviewer; fan-out aggregator; priority routing & Py, OCaml \\
